...
<main class="container">
    ...
    <div class="mb-2 row">
        ...
        <div class="col-md-4 overflow-hidden border rounded shadow-sm row g-0 flex-md-row h-md-250 position-relative">
            <div class="p-4 mb-3 ">
                <?php if (have_posts()): while (have_posts()) :
                the_post(); ?>
                <h4 class="fst-italic"><?php the_field('nom'); ?>  <?php the_field('prenom'); ?></h4>
            ...
            <div class="mb-4 overflow-hidden border rounded shadow-sm row g-0 flex-md-row h-md-250 position-relative">
                <div class="p-4 col d-flex flex-column position-static">
                    <?php if (have_posts()): while (have_posts()) : the_post(); ?>
                        <h4 class="fst-italic"><?php the_field('nom'); ?>  <?php the_field('prenom'); ?></h4>
                        <p class="mb-auto"><?php the_field('description'); ?></p>
                    <?php endwhile; ?>
                    <?php endif ?>
                </div>
                <?php if (have_posts()): while (have_posts()) : the_post(); ?>
                    <table class="table">
                        ...
                        <tbody>
                        <tr>
                            <td><?php the_field('nom'); ?>  <?php the_field('prenom'); ?></td>
                            <td>
                                <?php
                            ...
                            <td><?php the_field('profession'); ?></td>
                            <td><?php the_field('pays'); ?></td>
                            <td><?php the_terms(get_the_ID(),'guest_type');  ?></td>
        ...
        <div class=" col-md-2 overflow-hidden border rounded shadow-sm row g-0 flex-md-row h-md-250 position-relative">
